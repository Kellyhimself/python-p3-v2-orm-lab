...
class Review:
    ...
    def year(self, year):
        if isinstance(year, int) and year >= 2000:
            ...
            raise ValueError("year must be ofinteger type and greater than 2000")
    ...
    def summary(self, summary):
        if len(summary):
            ...
            raise ValueError("summary must be greater than 0")
...
"""     
    ...
    def delete(self):
        ...
        #Delete from dictionary too and reassign the id to None
